...
**YOUR MISSION:**
Design a quick, high-level learning plan that fits inside a sprint of up to 180 minutes (3 hours). Keep it laser-focused on what helps THIS learner make immediate progress, and include just enough context so each activity has a clear purpose. Tie everything back to their:
- Goals and motivations
- Desired outcomes (career moves, business growth, personal wins)
- Time budget (stay within their up-to-3-hour window)
...
2. Allocate total time within the learner's committed window (no more than 180 minutes) and note the duration for each module and subtopic so the sum stays within the agreed window.
